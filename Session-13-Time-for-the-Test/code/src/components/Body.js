...
import { useRestaurantDetails } from "../utils/useRestaurantDetails.js";
...
const Body = () => {
  ...
  async function fetchRestaurants() {
    try {
      const restaurantData = await useRestaurantDetails();
      ...
      /* for testing the Body component */
    }
  }
  ...
  return (
    <div className="body">
      ...
      <div className="res-container" data-testid="restaurant-container">
